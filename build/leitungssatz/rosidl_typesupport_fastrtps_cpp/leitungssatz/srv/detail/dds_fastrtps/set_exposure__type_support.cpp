...
#include "leitungssatz/srv/detail/set_exposure__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = leitungssatz::srv::SetExposure_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const leitungssatz::srv::SetExposure_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<leitungssatz::srv::SetExposure_Request *>(
    untyped_ros_message);
...
{
  return &leitungssatz::srv::typesupport_fastrtps_cpp::_SetExposure_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = leitungssatz::srv::SetExposure_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const leitungssatz::srv::SetExposure_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<leitungssatz::srv::SetExposure_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &leitungssatz::srv::typesupport_fastrtps_cpp::_SetExposure_Response__handle;
}
...
{
  return &leitungssatz::srv::typesupport_fastrtps_cpp::_SetExposure__handle;
}

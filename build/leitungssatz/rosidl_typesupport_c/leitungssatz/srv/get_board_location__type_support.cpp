...
static const _GetBoardLocation_Request_type_support_symbol_names_t _GetBoardLocation_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, leitungssatz, srv, GetBoardLocation_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, leitungssatz, srv, GetBoardLocation_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, leitungssatz, srv, GetBoardLocation_Request)() {
  return &::leitungssatz::srv::rosidl_typesupport_c::GetBoardLocation_Request_message_type_support_handle;
}
...
static const _GetBoardLocation_Response_type_support_symbol_names_t _GetBoardLocation_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, leitungssatz, srv, GetBoardLocation_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, leitungssatz, srv, GetBoardLocation_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, leitungssatz, srv, GetBoardLocation_Response)() {
  return &::leitungssatz::srv::rosidl_typesupport_c::GetBoardLocation_Response_message_type_support_handle;
}
...
static const _GetBoardLocation_type_support_symbol_names_t _GetBoardLocation_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, leitungssatz, srv, GetBoardLocation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, leitungssatz, srv, GetBoardLocation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, leitungssatz, srv, GetBoardLocation)() {
  return &::leitungssatz::srv::rosidl_typesupport_c::GetBoardLocation_service_type_support_handle;
}

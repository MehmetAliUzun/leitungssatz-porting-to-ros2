...
static const _GetRedBlock_Request_type_support_symbol_names_t _GetRedBlock_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, leitungssatz, srv, GetRedBlock_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, leitungssatz, srv, GetRedBlock_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, leitungssatz, srv, GetRedBlock_Request)() {
  return &::leitungssatz::srv::rosidl_typesupport_c::GetRedBlock_Request_message_type_support_handle;
}
...
static const _GetRedBlock_Response_type_support_symbol_names_t _GetRedBlock_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, leitungssatz, srv, GetRedBlock_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, leitungssatz, srv, GetRedBlock_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, leitungssatz, srv, GetRedBlock_Response)() {
  return &::leitungssatz::srv::rosidl_typesupport_c::GetRedBlock_Response_message_type_support_handle;
}
...
static const _GetRedBlock_type_support_symbol_names_t _GetRedBlock_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, leitungssatz, srv, GetRedBlock)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, leitungssatz, srv, GetRedBlock)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, leitungssatz, srv, GetRedBlock)() {
  return &::leitungssatz::srv::rosidl_typesupport_c::GetRedBlock_service_type_support_handle;
}

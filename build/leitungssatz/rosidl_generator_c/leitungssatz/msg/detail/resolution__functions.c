...
leitungssatz__msg__Resolution__create()
{
  ...
  leitungssatz__msg__Resolution * msg = (leitungssatz__msg__Resolution *)allocator.allocate(sizeof(leitungssatz__msg__Resolution), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(leitungssatz__msg__Resolution));
  bool success = leitungssatz__msg__Resolution__init(msg);
  if (!success) {
...
leitungssatz__msg__Resolution__destroy(leitungssatz__msg__Resolution * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    leitungssatz__msg__Resolution__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
leitungssatz__msg__Resolution__Sequence__init(leitungssatz__msg__Resolution__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leitungssatz__msg__Resolution * data = NULL;

  if (size) {
    data = (leitungssatz__msg__Resolution *)allocator.zero_allocate(size, sizeof(leitungssatz__msg__Resolution), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = leitungssatz__msg__Resolution__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        leitungssatz__msg__Resolution__fini(&data[i - 1]);
      }
...
leitungssatz__msg__Resolution__Sequence__fini(leitungssatz__msg__Resolution__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      leitungssatz__msg__Resolution__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leitungssatz__msg__Resolution__Sequence * array = (leitungssatz__msg__Resolution__Sequence *)allocator.allocate(sizeof(leitungssatz__msg__Resolution__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = leitungssatz__msg__Resolution__Sequence__init(array, size);
  if (!success) {
...
leitungssatz__msg__Resolution__Sequence__destroy(leitungssatz__msg__Resolution__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    leitungssatz__msg__Resolution__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
leitungssatz__msg__Resolution__Sequence__are_equal(const leitungssatz__msg__Resolution__Sequence * lhs, const leitungssatz__msg__Resolution__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!leitungssatz__msg__Resolution__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  leitungssatz__msg__Resolution__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(leitungssatz__msg__Resolution);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    leitungssatz__msg__Resolution * data =
      (leitungssatz__msg__Resolution *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!leitungssatz__msg__Resolution__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          leitungssatz__msg__Resolution__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!leitungssatz__msg__Resolution__copy(

...
leitungssatz__srv__AddTf2_Request__init(leitungssatz__srv__AddTf2_Request * msg)
{
  ...
  // pose
  if (!geometry_msgs__msg__TransformStamped__init(&msg->pose)) {
    leitungssatz__srv__AddTf2_Request__fini(msg);
    return false;
  }
  // relative
  return true;
...
leitungssatz__srv__AddTf2_Request__fini(leitungssatz__srv__AddTf2_Request * msg)
{
  ...
  // pose
  geometry_msgs__msg__TransformStamped__fini(&msg->pose);
  // relative
}
...
leitungssatz__srv__AddTf2_Request__create()
{
  ...
  leitungssatz__srv__AddTf2_Request * msg = (leitungssatz__srv__AddTf2_Request *)allocator.allocate(sizeof(leitungssatz__srv__AddTf2_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(leitungssatz__srv__AddTf2_Request));
  bool success = leitungssatz__srv__AddTf2_Request__init(msg);
  if (!success) {
...
leitungssatz__srv__AddTf2_Request__Sequence__init(leitungssatz__srv__AddTf2_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leitungssatz__srv__AddTf2_Request * data = NULL;

  if (size) {
    data = (leitungssatz__srv__AddTf2_Request *)allocator.zero_allocate(size, sizeof(leitungssatz__srv__AddTf2_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = leitungssatz__srv__AddTf2_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        leitungssatz__srv__AddTf2_Request__fini(&data[i - 1]);
      }
...
leitungssatz__srv__AddTf2_Request__Sequence__fini(leitungssatz__srv__AddTf2_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      leitungssatz__srv__AddTf2_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leitungssatz__srv__AddTf2_Request__Sequence * array = (leitungssatz__srv__AddTf2_Request__Sequence *)allocator.allocate(sizeof(leitungssatz__srv__AddTf2_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = leitungssatz__srv__AddTf2_Request__Sequence__init(array, size);
  if (!success) {
...
leitungssatz__srv__AddTf2_Request__Sequence__destroy(leitungssatz__srv__AddTf2_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    leitungssatz__srv__AddTf2_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
leitungssatz__srv__AddTf2_Request__Sequence__are_equal(const leitungssatz__srv__AddTf2_Request__Sequence * lhs, const leitungssatz__srv__AddTf2_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!leitungssatz__srv__AddTf2_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  leitungssatz__srv__AddTf2_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(leitungssatz__srv__AddTf2_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    leitungssatz__srv__AddTf2_Request * data =
      (leitungssatz__srv__AddTf2_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!leitungssatz__srv__AddTf2_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          leitungssatz__srv__AddTf2_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!leitungssatz__srv__AddTf2_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leitungssatz__srv__AddTf2_Response * msg = (leitungssatz__srv__AddTf2_Response *)allocator.allocate(sizeof(leitungssatz__srv__AddTf2_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(leitungssatz__srv__AddTf2_Response));
  bool success = leitungssatz__srv__AddTf2_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
leitungssatz__srv__AddTf2_Response__destroy(leitungssatz__srv__AddTf2_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    leitungssatz__srv__AddTf2_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
leitungssatz__srv__AddTf2_Response__Sequence__init(leitungssatz__srv__AddTf2_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leitungssatz__srv__AddTf2_Response * data = NULL;

  if (size) {
    data = (leitungssatz__srv__AddTf2_Response *)allocator.zero_allocate(size, sizeof(leitungssatz__srv__AddTf2_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = leitungssatz__srv__AddTf2_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        leitungssatz__srv__AddTf2_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
leitungssatz__srv__AddTf2_Response__Sequence__fini(leitungssatz__srv__AddTf2_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      leitungssatz__srv__AddTf2_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leitungssatz__srv__AddTf2_Response__Sequence * array = (leitungssatz__srv__AddTf2_Response__Sequence *)allocator.allocate(sizeof(leitungssatz__srv__AddTf2_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = leitungssatz__srv__AddTf2_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
leitungssatz__srv__AddTf2_Response__Sequence__destroy(leitungssatz__srv__AddTf2_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    leitungssatz__srv__AddTf2_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
leitungssatz__srv__AddTf2_Response__Sequence__are_equal(const leitungssatz__srv__AddTf2_Response__Sequence * lhs, const leitungssatz__srv__AddTf2_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!leitungssatz__srv__AddTf2_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  leitungssatz__srv__AddTf2_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(leitungssatz__srv__AddTf2_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    leitungssatz__srv__AddTf2_Response * data =
      (leitungssatz__srv__AddTf2_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!leitungssatz__srv__AddTf2_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          leitungssatz__srv__AddTf2_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!leitungssatz__srv__AddTf2_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }

...
#ifndef LEITUNGSSATZ__SRV__DETAIL__GET_FINISHED__FUNCTIONS_H_
#define LEITUNGSSATZ__SRV__DETAIL__GET_FINISHED__FUNCTIONS_H_
...
/// Initialize srv/GetFinished message.
/**
...
/// Finalize srv/GetFinished message.
/**
...
/// Create srv/GetFinished message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * leitungssatz__srv__GetFinished_Request__init().
...
/// Destroy srv/GetFinished message.
/**
 * It calls
 * leitungssatz__srv__GetFinished_Request__fini()
...
/// Check for srv/GetFinished message equality.
/**
...
/// Copy a srv/GetFinished message.
/**
...
/// Initialize array of srv/GetFinished messages.
/**
...
/// Finalize array of srv/GetFinished messages.
/**
 * It calls
 * leitungssatz__srv__GetFinished_Request__fini()
...
/// Create array of srv/GetFinished messages.
/**
 * It allocates the memory for the array and calls
 * leitungssatz__srv__GetFinished_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetFinished messages.
/**
 * It calls
 * leitungssatz__srv__GetFinished_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetFinished message array equality.
/**
...
/// Copy an array of srv/GetFinished messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * leitungssatz__srv__GetFinished_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_leitungssatz
...
/**
 * It calls
 * leitungssatz__srv__GetFinished_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_leitungssatz
...
/**
 * It allocates the memory for the array and calls
 * leitungssatz__srv__GetFinished_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_leitungssatz
...
/**
 * It calls
 * leitungssatz__srv__GetFinished_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LEITUNGSSATZ__SRV__DETAIL__GET_FINISHED__FUNCTIONS_H_

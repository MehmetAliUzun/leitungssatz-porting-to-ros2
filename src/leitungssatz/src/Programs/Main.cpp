...
int main(int argc, char **argv) {
    ...
    // Close connectors Tasks -> If problems occur try this option: auto move_home = std::make_shared<leitungssatz::InterTask>();

     auto move_home = std::make_shared<leitungssatz::InterTask>();

     auto connector1Grasping = std::make_shared<leitungssatz::InterTask>();
     auto connector2Grasping = std::make_shared<leitungssatz::InterTask>();
     auto connector3Grasping = std::make_shared<leitungssatz::InterTask>();
     auto connector4Grasping = std::make_shared<leitungssatz::InterTask>();

     auto cable_red = std::make_shared<leitungssatz::InterTask>();
     auto cable_yellow = std::make_shared<leitungssatz::InterTask>();
     auto cable_yellow2 = std::make_shared<leitungssatz::InterTask>();

     auto cable_black = std::make_shared<leitungssatz::InterTask>();
     auto cable_orientation = std::make_shared<leitungssatz::InterTask>();
    ...
    auto connector1_pick_up_and_insert = std::make_shared<leitungssatz::InterTask>();
    ...
    auto connector2_pick_up_and_insert = std::make_shared<leitungssatz::InterTask>();
    ...
    auto connector3_pick_up_and_insert = std::make_shared<leitungssatz::InterTask>();

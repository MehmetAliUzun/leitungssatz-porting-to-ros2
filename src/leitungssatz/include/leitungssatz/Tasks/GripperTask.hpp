...
public:
    ...
    GripperTask(Robot_ptr robot, double target_position, bool asynchronous)
    : Task(robot), _target_position(target_position), _asynchronous(asynchronous){}

    GripperTask(Robot_ptr robot, double target_position, double speed, double force, bool asynchronous)
